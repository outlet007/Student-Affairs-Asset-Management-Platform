...
async function setup() {
  ...
  if (catCount === 0) {
    await Category.bulkCreate([
      { name: 'อุปกรณ์สำนักงาน', description: 'เครื่องเขียน กระดาษ หมึกพิมพ์ ฯลฯ' },
      { name: 'อุปกรณ์อิเล็กทรอนิกส์', description: 'คอมพิวเตอร์ จอภาพ เครื่องพิมพ์ ฯลฯ' },
      { name: 'อุปกรณ์กีฬา', description: 'ลูกบอล ตาข่าย อุปกรณ์กีฬาต่างๆ' },
      { name: 'เฟอร์นิเจอร์', description: 'โต๊ะ เก้าอี้ ตู้เก็บของ ฯลฯ' },
      { name: 'อุปกรณ์กิจกรรม', description: 'เต็นท์ ป้ายไวนิล ไมค์ ลำโพง ฯลฯ' }
    ]);
